...
function pdn_breadcrumbs() {
	...
	if ($show_on_home == 1) echo '<div class="widget-title"><a href="' . $home_link . '">' . $text['home'] . '</a></div>';

	} else {

	echo '<div class="widget-title" xmlns_v="http://rdf.data-vocabulary.org/#">';
	if ($show_home_link == 1) {
