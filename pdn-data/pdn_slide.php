...
/*** POST TYPE SLIDE ***/
	...
	register_post_type( 'pdn_slide',		
	array(			
	    'menu_icon' => 'dashicons-format-video',
		'description' => 'TSSTSTSTSTSTSTSTST',
		'labels' => array(				
	    'name' => __( 'Slide' ),				
		...
		'register_meta_box_cb' => 'pdn_slide_meta_box',
		 )	
    );
	
	function pdn_slide_meta_box() {
	    add_meta_box('pdn_slide_meta_box_isi', 'Penting dibaca', 'pdn_slide_meta_box_isi', 'pdn_slide', 'normal', 'default');
	}
	
	function pdn_slide_meta_box_isi() {
	    ?>
			<div>
				<ul>
				<li>1. Untuk menambahkan slide, silahkan isi pada bagian <b><i>Featured Image / Gambar Unggulan</i></b> di sebelah kanan bawah</li>
				<li>2. Klik Set Featured Image</li>
				<li>3. Ukuran Gambar yang disarankan untuk slide adalah: <b> Lebar: 1536px, Tinggi: 680px </b></li>
				</ul>
			</div>
			<br/>
			<br/>
